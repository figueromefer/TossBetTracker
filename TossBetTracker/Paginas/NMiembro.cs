...
{
    public class NMiembro : ContentPage
    {
        ...
        public async void enviar_a_usuarios()
        {
            try
            {
                string uriString1 = string.Format("http://toss.boveda-creativa.com/agregar_grupo_existente.php?grupo={0}&usuarios={1}", grupo, usuarios);
